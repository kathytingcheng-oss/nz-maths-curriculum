globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/MathsApp-D5kkL-up.js","assets/layout-segment-context-DUTDjfLq.js"];
...
function getDraftSecret() {
	return "03f36a08-a3ba-41da-91a2-804a5fdd4ee4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "700dc883-e02b-4dd1-a7b7-1a2aedb766d0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "700dc883-e02b-4dd1-a7b7-1a2aedb766d0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "700dc883-e02b-4dd1-a7b7-1a2aedb766d0",
		rootBoundaryId
	});
}
/**
