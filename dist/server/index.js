globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/MathsApp-ZG9eV_Io.js","assets/layout-segment-context-DlmyXAEI.js"];
...
function getDraftSecret() {
	return "aba8b5fa-4259-4dd9-9ac1-7f6149c071ce";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e46280b5-ed85-4f19-b7a9-d58dcb469c85";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e46280b5-ed85-4f19-b7a9-d58dcb469c85") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e46280b5-ed85-4f19-b7a9-d58dcb469c85",
		rootBoundaryId
	});
}
/**
