globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/MathsApp-CNJDZbrl.js","assets/layout-segment-context-B4jSDdCC.js"];
...
function getDraftSecret() {
	return "62c430de-a9ed-4995-800a-74ad72c13bcd";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "87543b46-b659-4eb7-8260-035ae96a29c1";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "87543b46-b659-4eb7-8260-035ae96a29c1") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "87543b46-b659-4eb7-8260-035ae96a29c1",
		rootBoundaryId
	});
}
/**
...
var MathsApp_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "cba597c2b39c", "default");
//#endregion
//#region app/page.tsx
...
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(MathsApp_default, {});
}
...
async function generateMetadata() {
	...
	const base = `${incoming.get("x-forwarded-proto") || (host.includes("localhost") ? "http" : "https")}://${host}`;
