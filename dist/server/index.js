globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/MathsApp-B45Yen2l.js","assets/layout-segment-context-DkORToGp.js"];
...
function getDraftSecret() {
	return "e20015c5-7172-4c17-8e31-1ccd8a1bb70c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "bd4ea479-6372-45e3-9d67-449303c9d288";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "bd4ea479-6372-45e3-9d67-449303c9d288") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "bd4ea479-6372-45e3-9d67-449303c9d288",
		rootBoundaryId
	});
}
/**
