globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/MathsApp-Ds0tImGy.js","assets/layout-segment-context-DAeER-ui.js"];
...
function getDraftSecret() {
	return "d94a8adb-2af4-471a-b648-039bdc5d0e2e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "426b803c-53de-4932-bae0-ec9ed3de7cfa";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "426b803c-53de-4932-bae0-ec9ed3de7cfa") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "426b803c-53de-4932-bae0-ec9ed3de7cfa",
		rootBoundaryId
	});
}
/**
