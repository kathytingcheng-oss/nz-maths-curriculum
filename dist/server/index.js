globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/MathsApp-CcXtb5wD.js","assets/layout-segment-context-Df8iNXQf.js"];
...
function getDraftSecret() {
	return "54ea1ba0-2b8d-463a-acc5-d1047620b7ba";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "3ac8daaa-1f0f-42e9-bd81-33125cd3bd6a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "3ac8daaa-1f0f-42e9-bd81-33125cd3bd6a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "3ac8daaa-1f0f-42e9-bd81-33125cd3bd6a",
		rootBoundaryId
	});
}
/**
