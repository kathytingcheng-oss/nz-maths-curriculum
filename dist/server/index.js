globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/MathsApp-Dvj2tcAQ.js","assets/layout-segment-context-C43l_UIH.js"];
...
function getDraftSecret() {
	return "80d11cb1-4c75-4111-927e-a2cbd1b28fe2";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a89aece9-334d-4d2b-b6c3-100b34490f49";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a89aece9-334d-4d2b-b6c3-100b34490f49") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a89aece9-334d-4d2b-b6c3-100b34490f49",
		rootBoundaryId
	});
}
/**
