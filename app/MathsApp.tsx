...
const TOPICS: Topic[] = [
  { id:"numbers-120", strand:"Number", title:"Numbers to 120", focus:"Read • write • order", summary:"Read, write, order and describe whole numbers up to 120.", outcomes:["Recognise, read and write numbers to 120","Order numbers from smallest to largest","Say the number before and after"], videoId:COMPILATION, videoStart:7, videoTitle:"Counting · Scratch Garden" },
  { id:"skip-counting", strand:"Number", title:"Counting & Skip Counting", focus:"Forward • backward • skip count", summary:"Count forwards and backwards in 1s, 2s, 5s and 10s from different starting points.", outcomes:["Count forwards and backwards","Skip count in 2s, 5s and 10s","Find missing numbers in a sequence"], videoId:"DhiklliLG80", videoTitle:"Skip Counting for Kids · Rock 'N Learn" },
  { id:"te-reo-numbers", strand:"Number", title:"Tau Māori to 100", focus:"Numbers in te reo Māori", summary:"Use te reo Māori for familiar numbers and build tens up to 100.", outcomes:["Recognise tahi to tekau","Build multiples of ten","Match English and te reo Māori numbers"], videoId:COMPILATION, videoStart:7, videoTitle:"Counting foundations · Scratch Garden", videoUrl:"https://www.youtube.com/results?search_query=te+reo+M%C4%81ori+numbers+1+to+100+for+children" },
  { id:"place-value", strand:"Number", title:"Place Value", focus:"Hundreds • tens • ones", summary:"Show numbers as hundreds, tens and ones, then partition them in different ways.", outcomes:["Identify hundreds, tens and ones","Partition numbers such as 47 = 40 + 7","Explain the value of each digit"], videoId:"T5Qf0qSSJFI", videoTitle:"Place Value · Math Antics" },
  { id:"number-line", strand:"Number", title:"Number Lines & Comparing", focus:"Estimate • compare • odd and even", summary:"Locate approximate values on a number line and compare numbers using mathematical language.", outcomes:["Place values approximately on a 0–120 line","Use <, > and =","Identify odd and even numbers"], videoId:COMPILATION, videoStart:344, videoTitle:"Estimating · Scratch Garden" },
  { id:"add-sub", strand:"Number", title:"Addition & Subtraction", focus:"Tens-and-ones strategies", summary:"Add and subtract by splitting numbers into tens and ones.", outcomes:["Add and subtract within 120","Use tens-and-ones strategies","Check whether an answer is reasonable"], videoId:"7J1OkxuyLD0", videoTitle:"Adding & Subtracting · Scratch Garden" },
  { id:"facts-doubles", strand:"Number", title:"Facts, Doubles & Halves", focus:"Facts within 20", summary:"Recall addition facts to 10 and explore related facts, doubles and halves to 20.", outcomes:["Recall addition facts to 10","Use related facts to 20","Find doubles and halves"], videoId:"7J1OkxuyLD0", videoStart:170, videoTitle:"Adding facts · Scratch Garden" },
  { id:"groups-sharing", strand:"Number", title:"Equal Groups & Sharing", focus:"Groups of 2 • 5 • 10", summary:"Model multiplication and division using equal groups, sharing and skip counting.", outcomes:["Make equal groups of 2, 5 and 10","Connect repeated addition to multiplication","Share a set equally"], videoId:"DhiklliLG80", videoStart:0, videoTitle:"Skip counting and equal groups · Rock 'N Learn" },
  { id:"fractions", strand:"Number", title:"Fractions", focus:"Halves • thirds • quarters", summary:"Recognise, show and compare halves, thirds and quarters of wholes and sets.", outcomes:["Recognise ½, ⅓ and ¼","Know that fractional parts must be equal","Find fractions of a set"], videoId:"362JVVvgYPE", videoTitle:"Fractions! · Scratch Garden" },
  { id:"money", strand:"Number", title:"New Zealand Money", focus:"Dollars • cents • totals to $20", summary:"Understand dollars and cents, recognise New Zealand money, make equal amounts and find totals up to $20.", outcomes:["Recognise NZ coin and note values","Know that 100 cents equals 1 dollar","Make and add money amounts up to $20"], videoId:"DbYbIB4m3RM", videoStart:533, videoTitle:"Dollars and Cents · Math Antics" },
  { id:"equations", strand:"Algebra", title:"True Equations & Missing Numbers", focus:"Equal means the same value", summary:"Understand equality, decide whether number sentences are true, and solve open equations.", outcomes:["Understand that = means both sides are equal","Use =, < and >","Find a missing number"], videoId:"7J1OkxuyLD0", videoStart:310, videoTitle:"Equations · Scratch Garden" },
  { id:"patterns", strand:"Algebra", title:"Repeating Patterns", focus:"Find • continue • explain", summary:"Identify the repeating unit, predict what comes next and find missing elements.", outcomes:["Identify what repeats","Continue three-element patterns","Describe a pattern rule"], videoId:COMPILATION, videoStart:2431, videoTitle:"Patterns · Scratch Garden" },
  { id:"length", strand:"Measurement", title:"Length with Informal Units", focus:"Estimate • measure • compare", summary:"Estimate and measure length consistently using steps, string, pencils or paper clips.", outcomes:["Estimate before measuring","Measure with equal informal units","Compare longer, shorter, depth and width"], videoId:"2wUsdsae0ro", videoTitle:"Measuring! · Scratch Garden" },
  { id:"mass-capacity", strand:"Measurement", title:"Mass & Capacity", focus:"Heavier • lighter • holds more", summary:"Estimate and compare weight and capacity using blocks, cups and everyday containers.", outcomes:["Compare heavier and lighter","Compare shallow and deep","Measure capacity with equal cupfuls"], videoId:"2wUsdsae0ro", videoStart:145, videoTitle:"Mass and capacity · Scratch Garden" },
  { id:"turns", strand:"Measurement", title:"Turns", focus:"Clockwise • anti-clockwise • fractions", summary:"Describe clockwise and anti-clockwise full, half, quarter and three-quarter turns.", outcomes:["Name common fractions of a turn","Distinguish clockwise and anti-clockwise","Predict a finishing direction"], videoId:COMPILATION, videoStart:3344, videoTitle:"Location & directions · Scratch Garden" },
  { id:"calendar", strand:"Measurement", title:"Calendar & Duration", focus:"Months • seasons • elapsed time", summary:"Order months and seasons, and describe spans using years, months, weeks, days and hours.", outcomes:["Name and order the months","Match NZ seasons to months","Choose sensible duration units"], videoId:COMPILATION, videoStart:3344, videoTitle:"Time and everyday maths · Scratch Garden" },
  { id:"clock", strand:"Measurement", title:"Analogue Time", focus:"O'clock • half past • quarter hours", summary:"Tell analogue time to the hour, half-hour and quarter-hour.", outcomes:["Read o'clock and half past","Read quarter past and quarter to","Match analogue language to digital time"], videoId:COMPILATION, videoStart:3344, videoTitle:"Time in everyday maths · Scratch Garden", videoUrl:"https://www.youtube.com/results?search_query=telling+time+quarter+past+quarter+to+for+kids" },
  { id:"shapes", strand:"Geometry", title:"2D & 3D Shapes", focus:"Name • describe • sort", summary:"Recognise, describe and sort shapes by edges, corners, faces and vertices.", outcomes:["Name common 2D and 3D shapes","Describe edges, faces and vertices","Sort shapes by their features"], videoId:"CYVmmTaqIPU", videoTitle:"Faces, Edges and Vertices · Noodle Kidz" },
  { id:"shape-moves", strand:"Geometry", title:"Slide & Turn Shape Patterns", focus:"Move • turn • continue", summary:"Slide and turn 2D shapes to create and continue patterns.", outcomes:["Recognise a slide","Recognise a turn","Predict the next shape orientation"], videoId:COMPILATION, videoStart:2880, videoTitle:"Shapes · Scratch Garden" },
  { id:"position", strand:"Geometry", title:"Position & Directions", focus:"Position • movement • routes", summary:"Follow and give movement instructions, including distances and turns, and read simple diagrams.", outcomes:["Use left, right, forward and backward","Follow multi-step directions","Describe an object's position"], videoId:COMPILATION, videoStart:3344, videoTitle:"Location & Directions · Scratch Garden" },
  { id:"collect-data", strand:"Statistics", title:"Collect & Represent Data", focus:"Tallies • tables • graphs", summary:"Sort and record data using tallies, tables, picture graphs and dot plots.", outcomes:["Choose a useful survey question","Record tally marks in groups of five","Read tables, picture graphs and dot plots"], videoId:COMPILATION, videoStart:3804, videoTitle:"Data · Scratch Garden" },
  { id:"interpret-data", strand:"Statistics", title:"Compare & Explain Data", focus:"Compare • answer • conclude", summary:"Compare results and choose or write the statement that best answers a statistical question.", outcomes:["Find most and least common categories","Answer how many more and total questions","Choose a conclusion supported by data"], videoId:COMPILATION, videoStart:3804, videoTitle:"Understanding Data · Scratch Garden" },
];
...
function makeQuestions(topic:Topic,setIndex:number):Question[]{
  ...
  for(let i=0;i<20;i++){
    if(topic.id==="numbers-120"){
      ...
      const values=[10,20,50,100,200,500,1000,2000],a=pick(values),b=pick(values.filter(v=>v+a<=2000)),total=a+b;
      const fmt=(v:number)=>v<100?`${v}c`:`$${Number.isInteger(v/100)?v/100:(v/100).toFixed(2)}`;
      if(i%4===0)out.push(q(`${fmt(a)} + ${fmt(b)} = ?`,fmt(total),[fmt(Math.max(10,total-10)),fmt(Math.min(2000,total+10)),fmt(Math.max(10,total-a))],"Put both amounts into cents or dollars, then add.",random));
      else if(i%4===1){const cents=pick([100,200,300,500,1000,2000]);out.push(q(`${cents} cents is the same as…`,fmt(cents),[fmt(Math.max(10,cents-100)),fmt(Math.min(2000,cents+100)),`${cents} dollars`],"Every 100 cents makes 1 dollar.",random))}
      else if(i%4===2){if(a===b){i--;continue}const larger=Math.max(a,b),smaller=Math.min(a,b);out.push(q(`Which amount is greater: ${fmt(a)} or ${fmt(b)}?`,fmt(larger),[fmt(smaller),fmt(Math.min(2000,larger+10)),"They are equal"],"Compare both amounts using the same unit.",random))}
      else{const target=pick([50,100,200,500,1000,2000]);const combinations:Record<number,string>={50:"20c + 20c + 10c",100:"50c + 50c",200:"$1 + $1",500:"$2 + $2 + $1",1000:"$5 + $5",2000:"$10 + $10"};out.push(q(`Which group makes ${fmt(target)}?`,combinations[target],[`${fmt(target)} + 10c`,fmt(Math.max(10,target-10)),`${fmt(target)} + ${fmt(target)}`],"Add the value of every New Zealand coin or note in the group.",random))}
...
export default function MathsApp(){
  ...
  return <main className="app-shell">
    ...
    <div className="workspace" id="top"><aside className="topic-list"><p className="list-label">{strand} trail</p>{TOPICS.filter(t=>t.strand===strand).map((t,index)=><button key={t.id} className={t.id===topic.id?"selected":""} onClick={()=>selectTopic(t)}><span className="topic-number">{String(index+1).padStart(2,"0")}</span><span><b>{t.title}</b><small>{t.focus}</small></span><i>{Object.keys(progress).filter(k=>k.startsWith(`${t.id}-`)).length}/10</i></button>)}</aside>
      <section className="lesson"><div className="trail"><span>{topic.strand}</span><b>Knowledge point {TOPICS.indexOf(topic)+1} of {TOPICS.length}</b></div><h1>{topic.title}</h1><p className="topic-focus">{topic.focus}</p><p className="summary">{topic.summary}</p>
        {topic.id==="money"&&<section className="money-guide" aria-label="New Zealand money guide"><div><p className="eyebrow">THE BIG IDEA</p><h2>Money tells us how much something is worth.</h2><p>New Zealand uses dollars and cents. One dollar has the same value as 100 cents.</p><div className="money-equation"><b>$1</b><span>=</span><b>100c</b></div></div><div><p className="eyebrow">NEW ZEALAND MONEY</p><div className="denominations"><span>10c</span><span>20c</span><span>50c</span><span>$1</span><span>$2</span><span>$5</span><span>$10</span><span>$20</span></div><p className="money-note"><b>Video note:</b> Math Antics uses US coins, but the dollars-and-cents maths works in New Zealand too. Ryan's practice below uses New Zealand money.</p></div></section>}
